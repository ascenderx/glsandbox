 ...
 * 
 ****************************************************************************/
// struct Glyph UTIL_GLYPH_A = {4, (const uint **) __UTIL_GLYPH_A__};
// struct Glyph UTIL_GLYPH_B = {8, (const uint **) __UTIL_GLYPH_B__};
// struct Glyph UTIL_GLYPH_C = {3, (const uint **) __UTIL_GLYPH_C__};
// struct Glyph UTIL_GLYPH_D = {4, (const uint **) __UTIL_GLYPH_D__};
struct Glyph __UTIL_GLYPHS__[] = {
    /* 0: A */ {4, (const uint **) __UTIL_GLYPH_A__},
    /* 1: B */ {8, (const uint **) __UTIL_GLYPH_B__},
    /* 2: C */ {3, (const uint **) __UTIL_GLYPH_C__},
    /* 3: D */ {4, (const uint **) __UTIL_GLYPH_D__},
};
...
void utilDrawText(const char * text, struct Point2f * center) {
    ...
    for (const char * c = text; *c; c++) {
        ...
        uint index = (uint) toupper(*c) - offset;
        if (index > 3) {
            continue;
        }
        __utilDrawGlyph__(__UTIL_GLYPHS__[index].vertices, __UTIL_GLYPHS__[index].length, x, y);
        // switch (*c) {
        //     case 'A':
        //     case 'a':
        //         __utilDrawGlyph__(UTIL_GLYPH_A.vertices, UTIL_GLYPH_A.length, x, y);
        //         break;
            
        //     case 'B':
        //     case 'b':
        //         __utilDrawGlyph__(UTIL_GLYPH_B.vertices, UTIL_GLYPH_B.length, x, y);
        //         break;

        //     case 'C':
        //     case 'c':
        //         __utilDrawGlyph__(UTIL_GLYPH_C.vertices, UTIL_GLYPH_C.length, x, y);
        //         break;
            
        //     case 'D':
        //     case 'd':
        //         __utilDrawGlyph__(UTIL_GLYPH_D.vertices, UTIL_GLYPH_D.length, x, y);
        //         break;
